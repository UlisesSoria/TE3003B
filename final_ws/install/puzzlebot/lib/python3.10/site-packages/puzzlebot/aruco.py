...
class PuzzlebotAruco(Node):
    def __init__(self):
        ...
        self.declare_parameter('camera_matrix', [0., 0., 0., 0., 0., 0., 0., 0., 0.]) # Camera intrinsic matrix (3x3)
        self.declare_parameter('camera_distortion', [0., 0., 0., 0., 0.]) # Camera distortion coefficients (5x1)
    ...
    def camera_callback(self, msg):
        ...
        if len(corners) > 0:
            for corner, aruco_id in zip(corners, ids):
                ...
                transformed_point = self.tf_buffer.transform(marker_point, f'{self.namespace}base_footprint', timeout=rclpy.duration.Duration(seconds=1.0))
                ...
                aruco_observation_msg = ArucoMsg()
