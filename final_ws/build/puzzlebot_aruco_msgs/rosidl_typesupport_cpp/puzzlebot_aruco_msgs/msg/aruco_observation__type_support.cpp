...
static const _ArucoObservation_type_support_symbol_names_t _ArucoObservation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puzzlebot_aruco_msgs, msg, ArucoObservation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puzzlebot_aruco_msgs, msg, ArucoObservation)),
  }
};
...
{
  return &::puzzlebot_aruco_msgs::msg::rosidl_typesupport_cpp::ArucoObservation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, puzzlebot_aruco_msgs, msg, ArucoObservation)() {
  return get_message_type_support_handle<puzzlebot_aruco_msgs::msg::ArucoObservation>();
}
